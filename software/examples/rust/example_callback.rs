...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    // Create receiver for date and time events.
    let date_time_receiver = rtc.get_date_time_receiver();

    // Spawn thread to handle received events. This thread ends when the `rtc` object
